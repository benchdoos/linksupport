...
public final class SupportedMediaTypes {
    ...
    /**
     * {@link org.apache.tika.mime.MediaType} for {@link LinkType#WEBLOC_LINK}
     */
    ...
    /**
     * {@link org.apache.tika.mime.MediaType} for {@link LinkType#INTERNET_SHORTCUT_LINK}
     */
    ...
    /**
     * {@link org.apache.tika.mime.MediaType} for {@link LinkType#DESKTOP_LINK}
     */
    public static final MediaType APPLICATION_X_DESKTOP = new MediaType(APPLICATION, "x-desktop");

    @Getter
    private static final List<MediaType> allMediaTypes = Collections.unmodifiableList(
